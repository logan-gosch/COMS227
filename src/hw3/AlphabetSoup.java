...
import static hw3.api.Direction.*;
...
public class AlphabetSoup {
    ...
    public int[] getRowColumn(int rowOrColumn, Direction dir) {
        ...
        if (dir == DOWN) {
            for (i = 0; i < grid.length; i++) {
                result[i] = grid[(grid.length - 1) - i][rowOrColumn];
            }
        } else if (dir == UP) {
            for (i = 0; i < grid.length; i++) {
            ...
            for (i = 0; i < grid.length; i++) {
                result[i] = grid[rowOrColumn][i];
            }
        } else if (dir == RIGHT) {
            for (i = 0; i < grid.length; i++) {
                result[i] = grid[rowOrColumn][(grid.length - 1) - i];
            }
        }
        return result;
    }
    ...
    public void setRowColumn(int[] arr, int rowOrColumn, Direction dir) {
        ...
        if (dir == DOWN) {
            for (i = 0; i < grid.length; i++) {
                grid[(grid.length - 1) - i][rowOrColumn] = arr[i];
            }
        } else if (dir == UP) {
            for (i = 0; i < grid.length; i++) {
            ...
            for (i = 0; i < grid.length; i++) {
                grid[rowOrColumn][(grid.length - 1) - i] = arr[i];
            }
        }
    }
    ...
    public TileInfo setNewTile() {
        ...
        if (previousDirection == DOWN) {
            arr = getRowColumn(getSize() - 1, DOWN);
            for (int i = 0; i < arr.length; i++) {
                if (arr[i] == 0) {
                    indexOfEmpty.add(i);
                }
            }
            newTilePosition = arr[random.nextInt(indexOfEmpty.size())];
