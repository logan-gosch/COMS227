...
public class NormalizedMove
{
  ...
  public String toString()
  {
    ...
    String newToDisplay = "" + (char)('a' + newValue - 1);
    if (merged)
    {
      return "---> Merging " + toDisplay + " in "+ oldPos +
          " with " + newPos + ", resulting new value " + newToDisplay;
    }
    else
    {
      return "---> Moving " + toDisplay + " in "+ oldPos + " to " + newPos;
    }
